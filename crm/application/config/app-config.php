...
*
*/
define('APP_BASE_URL', 'https://va.suppliq.xyz/crm/');
...
*/
define('APP_ENC_KEY', 'fa8eb65773bff75cda437de4b3960a08');
 ...
 */
define('APP_DB_USERNAME', 'u209417434_crm_va_admin');

/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'fohi1|l8$O');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'u209417434_crm_va');
