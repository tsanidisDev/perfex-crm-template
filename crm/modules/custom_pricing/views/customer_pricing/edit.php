            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel_s">
                    <div class="panel-body">
                        <h4 class="no-margin"><?php echo _l('edit', _l('customer_pricing_singular')); ?></h4>
                        <hr class="hr-panel-heading" />
                        <?php echo form_open(current_url(), ['id' => 'customer-pricing-form']); ?>
                        <div class="row">
                            <div class="col-md-6">
                                <?php echo render_select('customer_id', $customers, ['userid', 'company'], 'customer', $pricing->customer_id); ?>
                            </div>
                            <div class="col-md-6">
